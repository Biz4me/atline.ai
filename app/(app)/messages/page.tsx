...
import { ChevronLeft, MessageSquare, Phone, Camera, Globe } from 'lucide-react'
...
export default function MessagesPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      {/* List */}
      <div className="flex flex-col gap-0 pt-4 pb-8">
        {conversations.map((conv) => {
          ...
          return (
            <button
              key={conv.id}
              type="button"
              onClick={() => toast.info(`${conv.firstName} ${conv.lastName}`)}
              className={cn(
            ...
            >
              ...
              <div className="relative shrink-0">
                ...
                <div
                  className="absolute -bottom-0.5 -right-0.5 flex size-5 items-center justify-center rounded-full border-2 border-background bg-background"
                >
