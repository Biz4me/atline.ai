...
const modulesData: Record<string, {
  ...
  m2: {
    ...
    duration: '30 min',
    color: 'bg-primary',
    description: "Apprends à alimenter en continu ta liste de contacts et à repérer les bons profils dans ta vie de tous les jours.",
    lessons: [
      { id: 'l1', title: "Qu'est-ce que la liste de noms ?", duration: '4 min', done: true, locked: false },
      { id: 'l2', title: 'La technique des 100 contacts', duration: '5 min', done: true, locked: false },
      { id: 'l3', title: 'Repérer les profils DISC dans la vraie vie', duration: '6 min', done: false, locked: false },
      { id: 'l4', title: 'Les brise-glaces pour récupérer les coordonnées', duration: '6 min', done: false, locked: false },
      { id: 'l5', title: 'Alimenter sa liste en continu', duration: '5 min', done: false, locked: false },
      { id: 'l6', title: 'Qualifier et prioriser ses contacts', duration: '4 min', done: false, locked: false },
    ],
  },
  m3: {
