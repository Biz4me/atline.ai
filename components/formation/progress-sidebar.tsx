...
export function ProgressSidebar({
  ...
  return (
    <Card className="hidden w-60 shrink-0 p-4 lg:block">
      <h3 className="text-sm font-medium text-foreground">Votre progression</h3>

      <div className="mt-4 space-y-4">
        {/* Streak */}
        <div className="flex items-center justify-between">
          <span className="text-[11px] text-muted-foreground">Streak</span>
          <span className="text-[13px] font-medium text-foreground">{streak} jours</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <span className="text-[13px] font-medium text-foreground">{nextBadge}</span>
        ...
        <div className="rounded-[8px] border border-primary/20 bg-primary/5 p-3">
          ...
          <p className="mt-1 text-[12px] text-foreground">{atlasRecommendation}</p>
        </div>
      </div>
    </Card>
  )
